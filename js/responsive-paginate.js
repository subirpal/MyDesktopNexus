    	    		...
    	    		if (candidate.length > 0)
    	    		{
    	    			for (var j = 0; j < candidate.length; j++)
    	    			{
    	    				...
    	    				if (this.isRemovable(candid_candidate))
    		    			{
    			    			...
    			    			{
    			    				this.els.eq(farthest_index - 2).before("<li class='disabled removable'><span class='abc'>...</span></li>");
    			    			}
    			    			if (this.needsEtcSign(1, active_index))
    			    			{
    			    				this.els.eq(1).after("<li class='disabled removable'><span class='abc'>...</span></li>");
    			    			}
    			    			return true;
    		    			}
    	    			}
